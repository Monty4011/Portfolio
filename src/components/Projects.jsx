  ...
  return (
    <>
      <div className="my-9" id="projects">
        <h1 className="text-3xl font-bold my-9 px-10">PROJECTS</h1>

        <div className="flex justify-center items-center gap-10 flex-wrap  ">
          {projects.map((data) => (
            <>
              <div
                className="border shadow-[5px_5px_10px_10px_rgba(101,175,10,0.5)] border-yellow-300 rounded-xl w-[240px] object-cover h-[330px] flex flex-col  justify-start items-center gap-5"
                data-aos="flip-right"
